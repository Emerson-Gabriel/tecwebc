                                ...
                                <table id="tabela" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr  style="<?php if ($row->finalizado == 1){echo 'background-color:#DFF0D8';}if ($row->cancelada == 1){echo 'background-color:#F2DEDE';}?>">
                                            <td>
                                                {{ $row->tcc }} - {{ $row->nomeAluno }} <?php if ($row->finalizado == 1){echo '<span class=\'badge badge-success\'>Finalizada</span>';}if ($row->cancelada == 1){echo '<span class=\'badge badge-danger\'>Cancelada</span>';}?>
                                            </td>
                                            <td>{{ $row->dataHora }}</td>
                                            <td>{{ $row->descricao }}</td>
                                            <td>
