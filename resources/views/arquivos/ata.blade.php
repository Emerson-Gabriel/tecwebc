...
<HTML>
    <HEAD>
        ...
        <TITLE>Ata - Marcação de Banca</TITLE>
    ...
    <BODY>
        ...
        <DIV id="page_1">
            ...
            <?php 
                ...
                $cursoUpper = mb_strtoupper($info[0]->nomeCurso);
            ...
            <?php 
                ...
                $i = 0;
                $total = count($avaliadores);
                $str = "";
                foreach ($avaliadores as $row2){
                    $i++;
                    if ($i < $total){
                        $str = $str . $row2->nome . ", ";
                    }else{
            ...
            obrigatório para a conclusão do curso de <?= $info[0]->nomeCurso ?>, 
        ...
        <TABLE cellpadding=0 cellspacing=0 class="t0">
            ...
            <TR>
                ...
                <TD class="tr1 td1">
                    ...
                    <P class="p11 ft3"><?= $avaliadores[0]->nome ?></P>
                </TD>
            </TR>
            <TR>
            <?php
            //foreach para rodar nos outros avaliadores
                foreach ($avaliadores as $row3){
                    
                    if (isset($avaliadores[3]->nome)){//duas validacao 
                        if ($row3->nome == $avaliadores[3]->nome){
                            break;
                        }
                    }
                    if (isset($avaliadores[4]->nome)){//duas validacao 
                        if ($row3->nome == $avaliadores[4]->nome){
                            break;
                        }
                    }
                    
                    if ($row3->nome <> $avaliadores[0]->nome){
                        if ($row3->nome == $avaliadores[1]->nome){
            ?>
                <TD class="tr1 td0">
                    <P class="p10 ft2">________________________________</P>
            ...
            <?php
                        ...
                        if (isset($avaliadores[2]->nome)){
                            if ($row3->nome == $avaliadores[2]->nome){
            ?>
                <TD class="tr1 td0">
                    <P class="p11 ft2">________________________________</P>
            ...
            <?php 
                if (isset($avaliadores[3]->nome)){
            ?>
            <TR>
                
                <TD class="tr1 td0">
                    <P class="p10 ft2">________________________________</P>
                    <P class="p10 ft3">{{ $avaliadores[3]->nome }}</P>
                </TD>

                <?php 
                    if (isset($avaliadores[4]->nome)){
                ?>
                <TD class="tr1 td1">
                    <P class="p11 ft2">________________________________</P>
                    <P class="p11 ft3"><?= $avaliadores[4]->nome ?></P>
                </TD>
                <?php 
                    }
                ?>
