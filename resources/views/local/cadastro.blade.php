                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Cadastro de Local</strong>
                                </div>
                                <div class="card-body">
                                    <div id="pay-invoice">
                                        <div class="card-body">
                                            <form id="formulario"  action="/local/salvar" method="post" novalidate="novalidate">
                                                <input type="hidden" name="_token" value ="{{csrf_token()}}" />
                                                <input type="hidden"  value="{{$local->idLocal}}" class="form-control-file" name="idLocal">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label for="descricao" class="control-label mb-1">Descrição do Local:</label>
                                                            <input value="{{$local->descricao}}" id="descricao" name="descricao" type="text" class="form-control required" placeholder="Descrição do local">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
