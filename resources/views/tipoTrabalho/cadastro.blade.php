                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Cadastro de Tipo de Trabalho</strong>
                                </div>
                                <div class="card-body">
                                    <div id="pay-invoice">
                                        <div class="card-body">
                                            <form id="formulario"  action="/tipo-de-trabalho/salvar" method="post" novalidate="novalidate">
                                                <input type="hidden" name="_token" value ="{{csrf_token()}}" />
                                                <input type="hidden"  value="{{$tipoTrabalho->idTipo}}" class="form-control-file" name="idTipo">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label for="nome" class="control-label mb-1">Nome do Tipo:</label>
                                                            <input value="{{$tipoTrabalho->nomeTipo}}" id="nome" name="nomeTipo" type="text" class="form-control required" placeholder="Nome do Tipo">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
